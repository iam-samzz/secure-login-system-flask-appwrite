/* mock-api.js disabled — left in the project for reference but not used. */
(function(){
  console.info('[mock-api] disabled — this file has been intentionally neutralized.');
})();
...
(function () {
  ...
  function authenticate(req) {
    // Extract Bearer token directly (fixed regex) instead of relying on getBearer()
